...
Here we are just getting a sense of the sizes of each of the five classes. Here we can see that BRCA is the largest class with 300 observations and that COAD is the smallest class with 78 observations.
```{r}
